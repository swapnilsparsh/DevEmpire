    ...
    <div className="container">
      ...
      <div className="card">
        <div className="content">
          ...
          <img className="image-cover" src="../img/Facebook.png" alt="" />
          <a
      ...
      <div class="card">
        <div class="content">
          <h3 className="heading">GitKraken Ambassador</h3>
      ...
      <div class="card">
        <div class="content">
          ...
          <img className="image-fill" src="../img/Gitlab.png" alt=""></img>
          <a
      ...
      <div class="card">
        <div class="content">
          ...
          <img className="image-fill" src="../img/IBM.jpg" alt=""></img>
      ...
      <div className="card">
        <div className="content">
          ...
          <img className="image-cover" src="../img/MLHFellowship.jpg" alt="" />
      ...
      <div class="card">
        <div class="content">
          <h3 className="heading">MLH Member Event</h3>
      ...
      <div class="card">
        <div class="content">
          <h3 className="heading">Prisma Ambassador</h3>
      ...
      <div class="card">
        <div class="content">
          ...
          <img className="image-cover" src="../img/TedFellow.jpg" alt=""></img>
          <a
