...
const Content = () => (
  <div>
    ...
    <div className="container">
      <div class="card">
        <div class="content">
          <a href="https://developer.amazon.com/en-IN/alexa/alexa-student-influencer#" target="_blank" rel="noreferrer">
            <h3>Alexa Student Influencer</h3>
            <img src="../img/Alexa.png"  alt="" ></img>
          </a>
        </div>
      </div>
      ...
      <div className="card">
        <div className="content">
          <a href="https://community.codecademy.com/chapters/" target="_blank" rel="noreferrer" >
            ...
            <img src="../img/Codecademy.jpg" alt="" />
          </a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="content">
          <a href="https://developers.google.com/community/gdg/organizers" target="_blank" rel="noreferrer">
      ...
      <div class="card">
        <div class="content">
          <a href="https://www.gitkraken.com/ambassador" target="_blank" rel="noreferrer">
            <h3>GitKraken Ambassador</h3>
            <img className="image" src="../img/GitKraken.jpg"  alt="" ></img>
          </a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="content">
          <a href="https://about.gitlab.com/community/heroes/" target="_blank" rel="noreferrer">
            <h3>GitLab Hero</h3>
      ...
      <div className="card">
        <div className="content">
          <a href="https://www.hackerearth.com/university/intro/" rel="noreferrer" >
      ...
      <div class="card">
        <div class="content">
          <a href="https://kotlinlang.org/user-groups/user-group-list.html" target="_blank" rel="noreferrer">
            <h3>Kotlin User Group</h3>
      ...
      <div class="card">
        <div class="content">
          <a href="https://mlh.io/event-membership" target="_blank" rel="noreferrer">
            <h3>MLH Member Event</h3>
      ...
      <div class="card">
        <div class="content">
          <a href="https://live.mongodb.com/start-a-group/" target="_blank" rel="noreferrer">
      ...
      <div class="card">
        <div class="content">
          <a href="https://www.prisma.io/ambassador" target="_blank" rel="noreferrer">
            <h3>Prisma Ambassador</h3>
            <img className="image"src="../img/Prisma.png"  alt="" ></img>
          </a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="content">
          <a href="https://www.ted.com/participate/ted-fellows-program" target="_blank" rel="noreferrer">
            <h3>TED Fellows Program</h3>
            <img src="../img/TedFellow.jpg"  alt="" ></img>
          </a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="content">
        <div class="tag - group"><span>Group</span></div>
          <a href="https://www.tensorflow.org/community/groups" target="_blank" rel="noreferrer">
            <h3>TensorFlow User Group</h3>
            <img src="../img/TensorFlow.png"  alt="" ></img>
          </a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="content">
          <a href="https://community.uipath.com/uipath-student-developers-program/" target="_blank" rel="noreferrer">
      ...
      <div class="card">
        <div class="content">
        <div class="tag - women"><span>Women</span></div>
          <a href="https://www.womentechmakers.com/ambassadors" target="_blank" rel="noreferrer">
