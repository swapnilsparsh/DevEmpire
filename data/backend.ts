...
const BackendData: Data[] = [
    {
        ...
        image: "/images/backend-img/Firebase.webp",
    ...
    },
    {
        ...
        image: "/images/backend-img/Auth0.webp",
    ...
    },
    {
        ...
        label: ["API"],
        image: "/images/backend-img/maps.webp",
    ...
    },
    {
        head: "Stripe",
        label: ["API"],
        image: "/images/backend-img/stripe.webp",
    ...
    },
    {
        head: "AWS",
        label: ["Cloud", "API"],
        image: "/images/backend-img/amazon-web-services.webp",
    ...
    },
    {
        head: "Youtube API",
        label: ["API"],
        image: "/images/backend-img/youtube.webp",
    ...
    },
    {
        head: "RapidAPI",
        label: ["API"],
        image: "/images/backend-img/api-settings.webp",
    ...
    },
    {
        head: "Movie API",
        label: ["API"],
        image: "/images/backend-img/imdb.webp",
    ...
    },
    {
        head: "MongoDB Atlas",
        label: ["Cloud"],
        image: "/images/backend-img/mongo-db.webp",
    ...
    },
    {
        head: "Spotify API",
        label: ["API"],
        image: "/images/backend-img/spotify--v1.webp",
    ...
    },
    {
        ...
        label: ["API"],
        image: "/images/backend-img/weather.webp",
    ...
    },
    {
        head: "Joke API",
        label: ["API"],
        image: "/images/backend-img/joke.webp",
    ...
    },
    {
        head: "Twitter API",
        label: ["API"],
        image: "/images/backend-img/twitter.webp",
    ...
    },
    {
        head: "Facebook API",
        label: ["API"],
        image: "/images/backend-img/facebook.webp",
    ...
    },
    {
        head: "Instagram API",
        label: ["API"],
        image: "/images/backend-img/instagram.webp",
    ...
    },
    {
        head: "PayPal API",
        label: ["API"],
        image: "/images/backend-img/paypal.webp",
    ...
    },
    {
        head: "WhatsApp API",
        label: ["API"],
        image: "/images/backend-img/whatsapp.webp",
    ...
    },
    {
        head: "PayTM API",
        label: ["API"],
        image: "/images/backend-img/paytm.webp",
    ...
    },
    {
        head: "Stock API",
        label: ["API"],
        image: "/images/backend-img/Alphvantage.webp",
    ...
    },
    {
        head: "Docker",
        label: ["Hosting"],
        image: "/images/backend-img/docker.webp",
    ...
    },
    {
        head: "Heroku",
        label: ["Hosting"],
        image: "/images/backend-img/heroku.webp",
    ...
    },
    {
        head: "Netlify",
        label: ["Hosting"],
        image: "/images/backend-img/netlify.webp",
    ...
    },
    {
        head: "Google Cloud",
        label: ["Cloud"],
        image: "/images/backend-img/google-cloud.webp",
    ...
    },
    {
        head: "Azure",
        label: ["Cloud"],
        image: "/images/backend-img/azure.webp",
    ...
    },
    {
        head: "Digital Ocean",
        label: ["Cloud"],
        image: "/images/backend-img/DigitalOcean.webp",
    ...
    },
    {
        head: "Vercel",
        label: ["Hosting"],
        image: "/images/backend-img/vercel.webp",
    ...
    },
    {
        head: "Back4App",
        label: ["Hosting"],
        image: "/images/backend-img/back4app.webp",
    ...
    },
    {
        head: "Postman",
        label: ["API Testing"],
        image: "/images/backend-img/postman.webp",
    ...
    },
    {
        head: "Insomnia",
        label: ["API Testing"],
        image: "/images/backend-img/insomnia.webp",
    ...
    },
    {
        head: "Thunder Client",
        label: ["API Testing"],
        image: "/images/backend-img/thunderclient.webp",
    ...
    },
    {
        ...
        label: ["API Testing"],
        image: "/images/backend-img/hopscotch.webp",
    ...
    },
    {
        head: "Passport",
        label: ["Authentication"],
        image: "/images/backend-img/passport.webp",
    ...
    },
    {
        head: "AWS Cognito",
        label: ["Authentication"],
        image: "/images/backend-img/aws-cognito.webp",
    ...
    },
    {
        head: "JWT",
        label: ["Authentication"],
        image: "/images/backend-img/jwt.webp",
        link: "https://jwt.io",
        about:
    ...
    },
    {
        head: "Okta",
        label: ["Authentication"],
        image: "/images/backend-img/okta-logo.webp",
    ...
    },
    {
        head: "Prisma",
        label: ["Cloud"],
        image: "/images/backend-img/Prisma.webp",
    ...
    },
    {
        ...
        label: ["API"],
        image: "/images/backend-img/The_New_York_Times_logo.webp",
    ...
    },
    {
        head: "Stytch Auth",
        label: ["Authentication"],
        image: "/images/backend-img/Stytch.webp",
    ...
    },
    {
        head: "Render",
        label: ["Hosting"],
        image: "/images/backend-img/Render.webp",
